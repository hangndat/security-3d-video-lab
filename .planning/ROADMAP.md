...
- [ ] **Phase 22: Scene Builder Parity** (0/2 plans — planned)
...
**Active milestone:** v1.5 Real 3D Render — Phase 21 next.

Run `/gsd-discuss-phase 21` or `/gsd-plan-phase 21` to begin headless capture foundation.
