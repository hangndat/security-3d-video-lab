...
- [x] **Phase 11: Narration Pipeline** (2/2 plans) — completed 2026-05-31
  ...
  - **Plans:** 2/2 plans complete
  - **Plan List:**
    - [x] `11-01-PLAN.md` — Branch-aware caption maps, narration schema, stub provider, alignment validator (VOIC-01).
    - [x] `11-02-PLAN.md` — Export bundle linkage, verify script, CI hook (VOIC-01 + VOIC-02).
  - **Success Criteria:**
